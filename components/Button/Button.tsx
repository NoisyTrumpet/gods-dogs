...
const styleLoader = (type: string) => {
  switch (type) {
    ...
    case "quaternary":
      return `rounded-full bg-quaternary py-2 px-4 font-bold text-white font-heading uppercase`;
    case "alert":
      return `rounded-full bg-alert py-2 px-4 font-bold text-white font-heading uppercase`;
    default:
      return `rounded-full bg-primary py-2 px-4 font-bold text-white font-heading uppercase`;
  }
};
